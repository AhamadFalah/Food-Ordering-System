 ...
 */
public class DrinksInHomePage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DrinksInHomePage() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ListItems=DHMI.SelectDrinkCoursesItems();
		request.setAttribute("listMenuItems", ListItems);
		d1=request.getRequestDispatcher("DrinksInHomePage.jsp");
