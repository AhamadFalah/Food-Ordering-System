 ...
 */
public class SearchDessertItem extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchDessertItem() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listMenuItems=DHMI.SearchDessertCoursesItems(search);
		if(listMenuItems.isEmpty()) {
			request.setAttribute("search", "error");
			d1=request.getRequestDispatcher("DessertInHomePage.jsp");
		}else {
