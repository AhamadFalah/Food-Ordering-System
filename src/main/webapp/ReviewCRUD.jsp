...
$(document).ready(function(){
    ...
    <div class="container">
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-xs-6">
							<a href="http://localhost:8080/JAVAWebApplication/ListReviewInCRUD" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>List All Reviews</span></a>	
        ...
        <c:set var="ReviewID" value="${ReviewList.getReview_ID()}" />
        ...
        <c:set var="review" value="${ReviewList.getReview()}"/>
            ...
            <tr>
                <td>${ReviewList.getReview_ID()}</td>
                <td>${ReviewList.getCustomer_id()}</td>
                <td>${ReviewList.getOrder_id()}</td>
                <td>${ReviewList.getRating()}</td>
                <td>${ReviewList.getReview()}</td>
         <c:url value="http://localhost:8080/JAVAWebApplication/DeleteReview" var="DeleteReview">
         	<c:param name="ReviewID" value="${ReviewID}"/>
         </c:url>
                <td><a href="${DeleteReview}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
            	</td>
			</tr>
	</c:forEach>
			</tbody>
