        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
         ...
         <form style="width: 23rem;" action="http://localhost:8080/JAVAWebApplication/UpdateQuantity" method="post">
			...
			<div class="form-group">
							<input type="text" id="CartID" value="<%=CartID %>" name="CartID">
							<input type="text" id="MenuItemID" value="<%=MenuItemID %>" name="MenuItemID">
			  </div>
			  <div class="form-group">
            ...
            <p>Go back to Admin DashBoard<a href="http://localhost:8080/JAVAWebApplication/ShoppingCart.jsp" class="link-info">Go back</a></p>
            </div>
