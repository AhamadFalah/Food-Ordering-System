...
<a href="http://localhost:8080/JAVAWebApplication/DessertsInHomePage" class="btn btn-primary" style="margin-left:1000px;">List Desserts</a>
...
<form action="http://localhost:8080/JAVAWebApplication/SearchDessertItem" method="get">
...
<div class="container" >
   <h3 class="title" style="magin-top:20px;"> Desserts  </h3>
