    ...
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
         ...
         <form style="width: 23rem;" action="http://localhost:8080/JAVAWebApplication/UploadMenuItemImage" method="post" enctype="multipart/form-data" >
			<br>
			<br>
            <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Upload Menu Item Picture</h3>
			<h4 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;"><%=request.getParameter("MenuItemName") %></h4>
	<div class="form-group">
							<input type="hidden" id="menuid" value="<%=request.getParameter("id") %>" name="MenuItemId">
							<input type="file" class="form-control" name="picture" required>
			  </div>	   
            <div class="pt-1 mb-4" style="margin-top:5px">
            <input type="submit" value="Done" type="button" class="btn btn-info btn-lg btn-block" />
...
if(update=="success"){
	swal("Food item picture successfully uploaded","Nice","success");
}
