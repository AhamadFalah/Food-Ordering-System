...
<% } %>-->
    ...
    <div class="container">
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2>Manage <b>Promo Codes</b></h2>
						</div>
						<div class="col-xs-6">
							<a href="http://localhost:8080/JAVAWebApplication/AddNewPromoCode.jsp" data-toggle="modal" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Add New Promo code</span></a>
							<a href="http://localhost:8080/JAVAWebApplication/ListAllPromoCodes" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>List Promo codes</span></a>	
        ...
        <c:set var="PromoID" value="${PromoList.getPromoID()}"/>
        <c:set var="name" value="${PromoList.getPromoCodeName()}"/>
        <c:set var="desc" value="${PromoList.getPromoDesc()}"/>
        <c:set var="value" value="${PromoList.getValue()}"/>
            <tr>
                <td>${PromoList.getPromoID()}</td>
                <td>${PromoList.getPromoCodeName()}</td>
                <td>${PromoList.getPromoDesc()}</td>
                <td>${PromoList.getValue()}</td>
         <c:url value="http://localhost:8080/JAVAWebApplication/EditPromoCode.jsp" var="updatePromo">
         	<c:param name="id" value="${PromoID}"/>
         	<c:param name="name" value="${name}"/>
         	<c:param name="desc" value="${desc}"/>
         	<c:param name="value" value="${value}"/>
         </c:url>
         <c:url value="http://localhost:8080/JAVAWebApplication/DeletePromoCode" var="promoDelete">
         	<c:param name="id" value="${PromoID}"/>
         </c:url>
                <td>
                <a href="${updatePromo}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                <a href="${promoDelete}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
