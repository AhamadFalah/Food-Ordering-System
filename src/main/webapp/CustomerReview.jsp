    ...
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
         ...
         <form style="width: 23rem;" action="http://localhost:8080/JAVAWebApplication/NewCustomerReview" method="post">
			<br>
			<br>
            <h4 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Review</h4>
            <h4 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Order Details</h4>
			<p  style="letter-spacing: 1px;"><%=CustomerOrderDetails %></p>	
            ...
            <input type="submit" value="Publish Review" type="button" class="btn btn-info btn-lg btn-block" />
