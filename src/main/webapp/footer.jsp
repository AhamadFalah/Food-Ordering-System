...
.footer {
    ...
    left: 0;
    right: 0;
    background-color: rgba(0, 0, 0, 0.2); /* Light black background color with transparency */
    padding: 20px; 
}
.container {
  max-width: 1200px;
        ...
        <div class="layout">
          <div class="layout_item w-50">
            <div class="newsletter">
              <h3 class="newsletter_title">Get updates on the latest Ramen innovations of yours in your inbox.</h3>
              <form action="">
