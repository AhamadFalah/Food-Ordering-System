		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="col-xs-6">
							<h2>Manage <b>User Profile</b></h2>
						</div>
						<div class="col-xs-6">
							
							<a href="http://localhost:8080/JAVAWebApplication/ListUser" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>List User Account</span></a>	
				...
				<div class="table-title">
					<div class="row">
						...
						<div class="col-xs-6">
							...
							<a href="http://localhost:8080/JAVAWebApplication/ListUser" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>List User Account</span></a>
					        <a href="http://localhost:8080/JAVAWebApplication/CreateExcelForUser" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Create Excel for Users</span></a>	
							<a href="AdminUI.jsp" class="btn btn-danger" ><i class="material-icons">&#xE15C;</i> <span>Go Back</span></a>						
						</div>
					</div>
				</div>
...
>>>>>>> branch 'master' of https://github.com/it22323934/Java-Web-Project/
</html>