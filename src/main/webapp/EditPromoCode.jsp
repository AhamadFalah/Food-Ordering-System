    ...
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
          ...
          <form style="width: 23rem;" action="http://localhost:8080/JAVAWebApplication/EditPromoCode" method="post">
			<br>
			<br>
            <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Edit Promo Code</h3>
			...
			<div class="form-group">
							...
							<input type="text" class="form-control" name="name" style="text-transform: uppercase" value="<%=name %>">
			  </div>
			<div class="form-group">
							<label>Promo code Description</label>
							<input type="text" class="form-control" name="desc" value="<%=desc %>" required>
			  </div>
            ...
            <p>Go back to Admin DashBoard<a href="http://localhost:8080/JAVAWebApplication/PromoCRUD.jsp" class="link-info">Go back</a></p>
            </div>
...
if(status1=="success"){
	swal("Successfully edited","Nice","success");
}
...
if(present=="success"){
	swal("Promo Code present already","Add a different promo code","error");
}
