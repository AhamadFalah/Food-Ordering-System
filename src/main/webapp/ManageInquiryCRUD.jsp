        ...
        <c:set var="Answer" value="${ListInquiry.getAnswer()}"/>
         ...
         <c:url value="DeleteInquiry.jsp" var="InquiryDelete">
         	...
         	<c:param name="Answer" value="${Answer}"/>
                ...
                <td><a href="${Answer}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Answer">&#xE254;</i></a>
                <a href="${InquiryDelete}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
