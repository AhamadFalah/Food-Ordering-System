    ...
    <div class="row">
      <div class="col-sm-6 text-black">
        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
          ...
          <form style="width: 23rem;" action="http://localhost:8080/JAVAWebApplication/AddNewPromoCode" method="post">
			<br>
			<br>
            <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Add new Promo Code</h3>
...
if(status1=="success"){
	swal("Promo Code Added","Nice","success");
}
