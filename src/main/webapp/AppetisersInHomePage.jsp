...
<a href="http://localhost:8080/JAVAWebApplication/ListAllAppetisers" class="btn btn-primary" style="margin-left:1000px;">List Appetisers</a>
...
<form action="http://localhost:8080/JAVAWebApplication/SearchApps" method="get">
...
<div class="container" >
   <h3 class="title" style="magin-top:20px;"> Appetisers  </h3>
...
<c:forEach var="MenuItem" items="${listMenuItems}">
        ...
        <c:set var="MenuItemUploadPath" value="${MenuItem.getMenuItemImageUrl()}"/>
         ...
         <c:url value="http://localhost:8080/JAVAWebApplication/AdditemToShoppingCart" var="itemToShoppingCart">
